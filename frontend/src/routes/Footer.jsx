  ...
  return (
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <a href="https://github.com/jan-Dro/" className="hover:text-blue-500">
          ...
          <a href="https://github.com/chris-galey/" className="hover:text-blue-500">
            <GitHubIcon fontSize="medium" /> Chris
          </a>
          <a href="https://github.com/joyceleechocolate" className="hover:text-blue-500">
            <GitHubIcon fontSize="medium" /> Joyce
          </a>
          <a href="https://github.com/harrygustavo" className="hover:text-blue-500">
            <GitHubIcon fontSize="medium" /> Harry
          </a>
        </div>
      </div>
      <div className="text-center mt-8">
        <p className="text-gray-500">&copy; 2023 SamurAI Stock. All rights reserved.</p>
      </div>
    </footer>
  );
}
